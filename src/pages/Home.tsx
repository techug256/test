...
const safariPackages = [
  {
    ...
    image: imagePath('images/gorilla.jpg'),
  ...
  },
  {
    ...
    image: imagePath('images/murchison.jpg'),
  ...
  },
  {
    ...
    image: imagePath('images/queen-elizabeth.jpg'),
...
const destinations = [
  {
    title: 'Bwindi Forest',
    image: imagePath('images/bwindi.jpg'),
    tours: '12 Tours',
    tag: 'Gorillas',
  },
  {
  ...
  {
    title: 'Kibale Forest',
    image: imagePath('images/chimpanzee.jpg'),
    tours: '6 Tours',
    tag: 'Chimpanzees',
  },
];
...
const testimonials = [
  {
    ...
    rating: 5,
    image: imagePath('images/safari-jeep.jpg'),
  },
  {
    name: 'Marcus Weber',
    country: 'Germany',
    ...
    rating: 5,
    image: imagePath('images/hippos.jpg'),
  },
  {
    name: 'Jennifer & David',
    country: 'Canada',
    ...
    rating: 5,
    image: imagePath('images/lake-bunyonyi.jpg'),
  },
];
    ...
    <div className="overflow-x-hidden">
      ...
      <section className="relative h-[100vh] min-h-[600px] flex items-center justify-center overflow-hidden">
        <div
          ...
          style={{ backgroundImage: `url(${imagePath('images/gorilla.jpg')})` }}
        />
      ...
      <section className="relative py-20 overflow-hidden">
        <div
          ...
          style={{ backgroundImage: `url(${imagePath('images/safari-jeep.jpg')})` }}
        />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <AnimatedSection delay={200}>
              <div className="grid grid-cols-2 gap-4">
                <img
                  src={imagePath('images/bwindi.jpg')}
                  alt="Bwindi Forest"
                  className="rounded-2xl h-48 object-cover w-full"
                />
                <img
                  src={imagePath('images/lodge.jpg')}
                  alt="Safari Lodge"
                  className="rounded-2xl h-48 object-cover w-full mt-8"
                />
                <img
                  src={imagePath('images/hippos.jpg')}
                  alt="Hippos"
                  className="rounded-2xl h-48 object-cover w-full -mt-8"
                />
                <img
                  src={imagePath('images/zebra.jpg')}
                  alt="Zebra"
                  className="rounded-2xl h-48 object-cover w-full"
                />
              </div>
