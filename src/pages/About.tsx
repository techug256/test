...
const team = [
  ...
  },
  {
    ...
    image: imagePath('images/lodge.jpg'),
  },
];
    ...
    <div className="overflow-x-hidden">
      ...
      <section className="relative h-[60vh] min-h-[400px] flex items-center justify-center">
        <div
          ...
          style={{ backgroundImage: `url(${imagePath('images/bwindi.jpg')})` }}
        />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <AnimatedSection delay={200}>
              <div className="grid grid-cols-2 gap-4">
                <img
                  src={imagePath('images/gorilla.jpg')}
                  alt="Gorilla"
                  className="rounded-2xl h-56 object-cover w-full"
                />
                <img
                  src={imagePath('images/chimpanzee.jpg')}
                  alt="Chimpanzee"
                ...
                />
                <img
                  src={imagePath('images/murchison.jpg')}
                  alt="Murchison Falls"
                  className="rounded-2xl h-56 object-cover w-full"
                />
              </div>
      ...
      <section className="py-20 bg-forest">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <AnimatedSection>
              <img
                src={imagePath('images/kampala.jpg')}
                alt="Uganda"
